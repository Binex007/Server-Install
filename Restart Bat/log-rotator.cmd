...
set arma3srvpath=C:\Server\Exile_3
...
copy "%arma3srvpath%\%servername%\arma33server_*.rpt" "%arma3srvpath%\%servername%\RotatedLogs\%dtStamp%\arma33server_*.rpt"
//copy "%arma3srvpath%\A3_GER.log" "%arma3srvpath%\%servername%\RotatedLogs\%dtStamp%\A3_GER.log"
copy "%arma3srvpath%\A3_GER_*_*_*.log" "%arma3srvpath%\%servername%\RotatedLogs\%dtStamp%\A3_GER_*_*_*.log"
...
del /Q /F "C:\Server\Exile_3\ARMAExtCS.txt"
del /Q /F "C:\Server\Exile_3\DMS_*.txt"
del /Q /F "%arma3srvpath%\%servername%\server_*.log"
del /Q /F "%arma3srvpath%\%servername%\arma33server_*.rpt"
del /Q /F "C:\Server\Exile_3\A3_GER_*_*_*.log"
